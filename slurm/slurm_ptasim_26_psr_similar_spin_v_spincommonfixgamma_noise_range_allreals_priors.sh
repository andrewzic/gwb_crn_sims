...
#SBATCH --output=/scratch2/zic006/gwb_crn_sims/slurm_logs/gwb_crn_sims_mc_spin_v_spincommonfg_noise_range_20210803_%A_%a.log
#SBATCH --ntasks=1
...
paramfiles=($(ls -v /scratch2/zic006/gwb_crn_sims/params/prior_range_test/[0-9]*.dat))
...
then
	...
	singularity exec /home/zic006/psr_gwb.sif python3 -m enterprise_warp.results --result ${PRFILE}  --info 1 -c 2 -p "gw" -f 1 -l 1 -m 1 -b 1 > /scratch2/zic006/gwb_crn_sims/result_logs/`basename ${PRFILE} .dat`.result
