...
#SBATCH --output=/scratch1/zic006/gwb_crn_sims/slurm_logs/pe_spincommonfixgamma__20210803_%A_%a.log
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --nodes=1
#SBATCH --time=0-03:00:00
#SBATCH --mem=4G
#SBATCH --array=1636-12100%1210
...
paramfiles=($(ls -v /scratch1/zic006/gwb_crn_sims/params/all_pe_array_spincommonfixgamma/all/params_all_pe_array_spincommonfixgamma_*_r[0-9]*.dat))
...
#grep -Fxq "Run complete with 11000 effective samples" /scratch1/zic006/gwb_crn_sims/slurm_logs/gwb_crn_sims_pe_spincommonfixgamma_noise_range_20210803_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.log;
