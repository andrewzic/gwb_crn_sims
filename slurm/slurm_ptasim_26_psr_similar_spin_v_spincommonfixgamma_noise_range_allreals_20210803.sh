#!/bin/bash
#SBATCH --job-name=gwb_crn_sims_mc_spin_v_spincommonfg_noise_range_allreal
#SBATCH --output=/flush5/zic006/gwb_crn_sims/slurm_logs/gwb_crn_sims_mc_spin_v_spincommonfg_noise_range_20210803_%A_%a.log
#SBATCH --ntasks=1
...
paramfiles=($(ls -v /flush5/zic006/gwb_crn_sims/params/all_mc_array_spin_v_spincommonfixgamma/params_all_mc_array_spin_v_spincommonfixgamma_??.??_?.??_20210803_r?.dat))
IFS=$'\n' paramfiles=($(sort -k1.140r <<<"${paramfiles[*]}")); unset IFS
